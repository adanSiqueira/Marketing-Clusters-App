...
from model.predict import processar_prever

# Carrega os modelos
encoder, scaler, kmeans = load_all_models()
...
if up_file is not None:
    st.write("""
        ...
        - **Grupo 1**: associado a esportes (futebol americano, basquete) e cultura (banda, rock).
        - **Grupo 2**: equilibrado, com interesses em música, dança e moda.
    """)

    df = pd.read_csv(up_file)
    cluster = processar_prever(df, encoder, scaler, kmeans)
